                ...
                <div class="col-sm-12">
                  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action dataTable no-footer" role="grid" aria-describedby="datatable-checkbox_info">
                    <thead>
                      ...
                      <th class="sorting" style="width: 139px;" align="center" >ตัวอย่างภาพ</th>
                      <th class="sorting" style="width: 232px;" align="center" >หัวข้อ</th>
                      <th class="sorting" style="width: 102px;" align="center" >วันที่</th>
                      <th class="sorting" style="width: 51px;" align="center" >สถานะ</th>
                      <th class="sorting" style="width: 100px;" align="center" >รายละเอียด</th>
                      <th class="sorting" style="width: 78px;" align="center" >ลบ</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <?php if (!isset($slide)) {
                     ...
                     <tr role="row" class="odd">
                      ...
                      <td align="center">Tiger Nixon</td>
                      <td align="center">System Architect</td>
                      <td align="center">Edinburgh</td>
                      <td align="center">61</td>
                      <td align="center"><a href="<?= base_url('control/'.$page.'/?type=edit&id='.$data['slide_id']); ?>" title=""><i class="fa fa-edit"></i></a></td>
                      <td align="center"><a href="" title=""><i class="fa fa-warning"></i></a></td>
                    </tr>
                    <?php } }?>
